-- Roblox Script: Pet System, Fruit Display & Admin Tools
-- Version: Decrypted Full
...
function PetSystem:AddPet(player, petType, customUUID)
    ...
    print("   : " .. petType .. "  " .. player.Name .. " (UUID: " .. petUUID .. ")")
    return petData
end
...
local function InitializeAdminTools()
    ...
    local Item_Module = {
        GiveItem = function(player, itemId, amount)
            ...
            print("  : " .. itemId .. " ×" .. amount .. "  " .. player.Name)
        ...
        RemoveItem = function(player, itemId)
            print("  : " .. itemId .. "  " .. player.Name)
            return true
        end,
        
        DuplicateItem = function(itemId, newOwner)
            print("  : " .. itemId .. "  : " .. tostring(newOwner))
            return true
        end
    }
        ...
        ScalePlayer = function(player, scaleFactor)
            if player.Character then
                ...
                if humanoid then
                    ...
                    -- Scale logic here
                    print("  : " .. player.Name .. " : " .. tostring(scaleFactor))
                end
            end
        end,
